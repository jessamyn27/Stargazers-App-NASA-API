...
m.hb=function(a){this.l=!0;if(void 0===a?0:a)this.C||gk(this)};
...
U.prototype.sendNetworkCheckRequest=U.prototype.Y;U.prototype.listen=U.prototype.ca;U.prototype.enableErrorFlushing=U.prototype.Sa;U.prototype.getWindowStatus=U.prototype.wa;U.prototype.monitorNetworkStatusChange=U.prototype.hb;U.prototype.isNetworkAvailable=U.prototype.L;U.getInstance=fk;function hk(a){a=void 0===a?{}:a;Me.call(this);var b=this;this.l=this.A=0;this.j=fk();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.j);c&&c(a.Ta);a.fb&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.j))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.j))a.oa?(this.oa=a.oa,c("ytnetworkstatus-online",function(){ik(b,"publicytnetworkstatus-online")}),c("ytnetworkstatus-offline",function(){ik(b,"publicytnetworkstatus-offline")})):
...
function rk(){nk||(nk=new hk({fb:!0,Ta:!0}));return nk}
...
!1}b=!b}b&&(b=a.client,f=!0,k=(f=void 0===f?!1:f)?16:8,d={csn:e,ve:d.getAsJson(),eventType:k},f={F:El(e),U:e,Va:f},"UNDEFINED_CSN"==e?Ml("visualElementHidden",d,f):b?Lh("visualElementHidden",d,b,f):Ek("visualElementHidden",d,f));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=p||"");Bm("csn",p);Nl.getInstance().clear();d=Al(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(O("web_mark_root_visible")||O("music_web_mark_root_visible"))&&(e=p,p=O("use_default_events_client")?void 0:Dk,b={csn:e,
ve:d.getAsJson(),eventType:1},f={F:El(e),U:e},"UNDEFINED_CSN"==e?Ml("visualElementShown",b,f):p?Lh("visualElementShown",b,p,f):Ek("visualElementShown",b,f));a.i.delete(c.layer||0);a.j=void 0;e=u(a.m);for(p=e.next();!p.done;p=e.next())p=u(p.value),b=p.next().value,p.next().value.has(c.layer)&&d&&Mm(a,b,d,c.layer)}
...
tn.prototype.D=function(){window.removeEventListener("message",this.A);L.prototype.D.call(this)};function un(){this.i=[];this.isReady=!1;this.j={};var a=this.h=new tn(!!E("WIDGET_ID_ENFORCE")),b=this.lb.bind(this);a.m=b;a.u=null;this.h.channel="widget";if(a=E("WIDGET_ID"))this.h.sessionId=a}
...
;function Pn(a,b,c,d){L.call(this);var e=this;this.G=b;this.webPlayerContextConfig=d;this.qa=!1;this.api={};this.ba=this.m=null;this.J=new M;this.i={};this.O=this.ga=this.elementId=this.ra=this.config=null;this.N=!1;this.l=this.A=null;this.ha={};this.Oa=["onReady"];this.lastError=null;this.Da=NaN;this.C={};this.Pa=new In(this);this.aa=0;this.j=this.u=a;Xd(this,Pa(Vd,this.J));Qn(this);Rn(this);Xd(this,Pa(Vd,this.Pa));c?this.aa=dg(function(){e.loadNewVideoConfig(c)},0):d&&(Sn(this),Tn(this))}
